...
LAYER = "raw"
SOURCE = "earthquake"
SCHEMA = "dm" # data mart(s) - витрина(ы) данных
TARGET_TABLE = "fct_count_day_earthquake"

# Имя подключения к Postgres DWH в Airflow
...
with DAG(
    ...
    # Удаления таблиц нужны во избежания дублирования и поддержки идемпотентности
